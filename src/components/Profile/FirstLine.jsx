...
function FL(props) {
    ...
    const dispatch=useDispatch(),[Notify,setNotify]=useState(null);
    return(<>{!props.UserInfo.avatar?<div className={props.AvaStock+' '+s.Avatar} onClick={(e)=>Script.uploadFile(Input)}>
    <p>У вас нет аватара.<br />Выберите из ваших файлов.</p></div>:<div className={props.Ava} onClick={(e)=>Script.uploadFile(Input)} />}
